...
logging.basicConfig(
    ...
    handlers=[RotatingFileHandler(filename='./logs/caprturarAlmacenarImagenes2.log', maxBytes=5000000, backupCount=30)],
)
...
def procesar_imagenes():
    ...
    try:
        while not stop_capture:
            ...
            time_to_sleep = max(10 - elapsed_time, 0)  # Asegurar que no sea negativo
